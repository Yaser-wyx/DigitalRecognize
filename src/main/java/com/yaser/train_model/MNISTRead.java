...
public class MNISTRead {
    ...
    private static Pair getDataSet(String imagePath, String labelPath, int size) {
        ...
        images = imageBinaryzation(images);
    ...
    /**
     *
     * @param images 需要二值化处理的图片
     * @return 返回二值化处理后的图片数据
     */
    private static double[][] imageBinaryzation(double[][] images) {
    ...
    /**
     * @description 获取图片数据集
     * @param fileName 要获取的图片数据集名字
     * @param size 要获取的图片数据大小
     * @return 返回图片数据集
     */
    ...
    /**
     *
     * @param fileName 要获取的标签数据集名字
     * @param size 要获取的标签数据集大小
     * @return 返回标签数据集
     */
